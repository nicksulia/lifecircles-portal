    ...
    render() {
        return (
            <div className="specialist-details-card-wrapper">
                <p>{this.props.displayedSpecialist && this.props.displayedSpecialist.description}</p>
                ...
                <span className="update-info">last update {this.props.displayedSpecialist && this.props.displayedSpecialist.modified_date}</span>
